...
module OneBRCParallelMmap
  ...
  file_parts.times do |ix|
    spawn do
      ...
      # Proceed for up to PARALLEL_MAX fibers
      # The rest wait to receive signal to proceed as earlier fibers finish
      spawn_chan.receive unless ix < PARALLEL_MAX
      ...
      begin
        ...
        coll_chan.send aggr
        # release a waiting fiber
        spawn_chan.send true
      end
    end
  end
